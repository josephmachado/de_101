...
def create_sample_sqlite_database(sqlite_db_file):
...
if __name__ == "__main__":
    ...
    parser.add_argument('--db_file', type=str, help="The TPCH database file to use.")
    parser.add_argument('--sqlite_db_file', type=str, help="The example sqlite3 database file to use.")
    
    # Parse the command line arguments
    args = parser.parse_args()
    
    # Check that at least one of --db_file or --sqlite_db_file was provided
    if not args.db_file and not args.sqlite_db_file:
        parser.error("At least one of --db_file or --sqlite_db_file must be provided.")
    ...
    if sqlite_db_file:
        ...
        create_sample_sqlite_database(sqlite_db_file)